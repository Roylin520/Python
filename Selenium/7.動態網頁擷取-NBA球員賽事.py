...
# 擷取總頁數
page_num = int(driver.find_element(By.XPATH, '/html/body/div[1]/div[2]/div[2]/div[3]/section[2]/div/div[2]/div[2]/div[1]/div[4]').text.split()[-1])
page_current = 1
...
while pages_remaining:
    ...
    data[0].to_csv("All_players_stats" + str(page_num) + ".csv", index=0)
